...
import { Mail, Lock, ArrowRight, Loader2, FileText } from "lucide-react";
    ...
    return (
        <div className="flex min-h-screen bg-white">
            ...
            <div className="hidden lg:flex lg:w-1/2 relative bg-blue-600 overflow-hidden">
                <div className="absolute inset-0 bg-[linear-gradient(to_bottom_right,#1e40af,#1e3a8a)]" />
                ...
                <div className="relative z-10 flex flex-col justify-between p-12 text-white h-full">
                    ...
                    <div className="max-w-md">
                        ...
                        <p className="text-blue-100 text-lg leading-relaxed">
                            Join thousands of professionals who have optimized their resumes and landed their dream jobs using our platform.
                        </p>
                    </div>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    type="email"
                                    required
                                    className="block w-full pl-10 pr-3 py-2.5 border border-gray-300 rounded-lg text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent transition-shadow sm:text-sm"
